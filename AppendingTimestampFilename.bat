...
SET /p FILEEXT="Please enter the file extension you want to append timestamp with:"
...
for /r . %%a in (*.%FILEEXT_UPP%) do (
  set myfiledate=%%~ta
  set year=!myfiledate:~6,4!
  set month=!myfiledate:~3,2!
  set day=!myfiledate:~0,2!
  set hour=!myfiledate:~0,2!
  set minute=!myfiledate:~3,2!
  set seconds=!myfiledate:~6,2!
  set timestamp=!year!
  set timestamp=!timestamp!!month!
  set timestamp=!timestamp!!day!
  set timestamp=!timestamp!_!hour!
  set timestamp=!timestamp!!minute!
  set timestamp=!timestamp!!seconds!
  set FILEEXT=%%~xa
  ren "%%a" !timestamp!_%%~na!FILEEXT!
)
